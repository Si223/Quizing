...
final List<Category> categories = [
  ...
  Category(11,"Movies", icon: FontAwesomeIcons.video),
  ...
  Category(18,"Technology", icon: FontAwesomeIcons.laptopCode),
  Category(19,"Maths", icon: FontAwesomeIcons.sortNumericDown),
  Category(20,"Mythology",icon: FontAwesomeIcons.book),
  ...
  Category(24,"Politics",icon: FontAwesomeIcons.angellist),
  ...
  Category(29,"Comics",icon: Icons.library_books),
  Category(30,"Gadgets", icon: FontAwesomeIcons.mobileAlt),
  Category(31,"Japanese Anime & Manga",icon: FontAwesomeIcons.odnoklassniki),
  Category(32,"Cartoon & Animation",icon: FontAwesomeIcons.smileWink),
];