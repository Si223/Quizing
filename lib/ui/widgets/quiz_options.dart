...
import 'package:quizing/models/category.dart';
import 'package:quizing/models/question.dart';
import 'package:quizing/resources/api_provider.dart';
import 'package:quizing/ui/pages/error.dart';
import 'package:quizing/ui/pages/quiz_page.dart';
    ...
    return SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Text("Select Number of Questions Acoording Your Choice"),
            SizedBox(
              width: double.infinity,
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  ActionChip(
                    ...
                    backgroundColor: _noOfQuestions == 10 ? Colors.purple : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(10),
                  ),
                  ActionChip(
                    label: Text("20"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 20 ? Colors.purple : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(20),
                  ),
                  ActionChip(
                    label: Text("30"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 30 ? Colors.purple: Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(30),
                  ),
                  ActionChip(
                    label: Text("40"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 40 ? Colors.purple : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(40),
                  ),
                  ActionChip(
                    label: Text("50"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 50 ? Colors.purple : Colors.grey.shade600,
